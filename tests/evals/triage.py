"""Survey cached Distill frames and propose a stratified eval shortlist.
...
DARK_LUMINANCE = 110.0  # matches distill.ocr._DARK_BACKGROUND_THRESHOLD
LOW_TEXT_CHARS = 8
HIGH_TEXT_CHARS = 60
...
def main() -> None:
    ...
    parser.add_argument(
        "--cache",
        type=Path,
        default=Path.home() / ".cache" / "distill",
        help="Distill cache root",
    )
