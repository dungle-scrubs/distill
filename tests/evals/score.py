"""Score Saccade's text recovery against the hand-written eval ground truth.
...
1. Word-error-rate (WER) of recovered text vs. truth, for text-bearing frames.
   ...
   scored too when ``--with-vision`` is set and Ollama is reachable.
...
from saccade.ocr import find_tesseract_command, ocr_frame
