...
def test_timeout_config_is_90_minutes() -> None:
    from distill.pipeline import configured_timeout_ms
...
def test_cli_accepts_rapid_mlx_local_vision_options() -> None:
    from distill.cli import build_parser
    ...
    assert args.local_vision_backend == "rapid-mlx"
...
def test_timeout_diagnostics_report_configured_and_effective_timeout() -> None:
    ...
    assert payload == {
        ...
        "effective_timeout_source": "DISTILL_EFFECTIVE_TIMEOUT_MS",
    }
